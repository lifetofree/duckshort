...
export const RATE_LIMIT_MAX_REQUESTS: 20 = 20
...
export const RATE_LIMIT_REDIRECT_MAX_REQUESTS: 200 = 200

// S-15 / S-16 / B-10 / B-11 / 4.2: validation bounds for user-supplied fields.
export const EXTEND_HOURS_MIN: 1 = 1
export const EXTEND_HOURS_MAX: 8_760 = 8_760 // 1 year
export const BULK_DELETE_MAX_IDS: 100 = 100
export const EXPORT_MAX_ROWS: 10_000 = 10_000

// Field-length caps to keep DB rows bounded (B-11).
export const MAX_TAG_LENGTH: 64 = 64
export const MAX_UTM_LENGTH: 200 = 200
export const MAX_OG_TITLE_LENGTH: 200 = 200
export const MAX_OG_DESCRIPTION_LENGTH: 500 = 500
